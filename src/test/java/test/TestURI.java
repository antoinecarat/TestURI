...
import org.eclipse.emf.common.util.URI_Const;
...
public class TestURI {
	...
	// Test de createGenericURI(String scheme, String opaquePart, String
	// fragment)
	...
	// Test de createHierarchicalURI(String scheme, String authority, String
	// device, String query, String fragment)
	@Test(expected = IllegalArgumentException.class)
	...
	public void testCreateHierarchicalURIA4() {
		...
		URI uri = URI.createHierarchicalURI(scheme, authority, device, query,
				fragment);
	...
	// Test de createHierarchicalURI(String scheme, String authority, String
	// device, String[] segments, String query, String fragment)
	@Test(expected = IllegalArgumentException.class)
	...
	public void testCreateHierarchicalURIB3() {
		...
		URI uri = URI.createHierarchicalURI(scheme, authority, device,
				segments, query, fragment);
		assertEquals(uri.toString(),
				"scheme://authority/device:/foo/bar?query#fragment");
	}

	// Test de createHierarchicalURI(String[] segments, String query, String
	// fragment)
	@Test(expected = IllegalArgumentException.class)
	...
	/*
	 * @Test(expected=IllegalArgumentException.class)//là c'est chiant public
	 * void testCreateURIA1(){ String value = ""; URI.createURI(value); }
	 */
	@Test
	 ...
	 * testCreateURIB1(){ String value = ""; boolean ignoreEsc = true;
	 * URI.createURI(value); }
	 */
	...
	/*
	 * @Test(expected=IllegalArgumentException.class) public void
	 * testCreateURIC1(){ String value = ""; boolean ignoreEsc = true;
	 * URI.createURI(value); }
	 */
	@Test()
	public void testCreateURIC2() {
		...
		boolean ignoreEsc = false;
		URI uri = URI.createURI(value, ignoreEsc, URI_Const.FRAGMENT_NONE);
	...
	public void testCreateURIC3() {
		...
		boolean ignoreEsc = false;
		URI uri = URI.createURI(value, ignoreEsc,
				URI_Const.FRAGMENT_FIRST_SEPARATOR);
	...
	public void testTrimQuery2() {
		...
		URI uri = URI.createHierarchicalURI(scheme, authority, device,
				segments, query, fragment);
		uri = uri.trimQuery();
		assertEquals("scheme://authority!/device:/foo/bar#fragment",
				uri.toString());
	}
	...
	public void testTrimFragment2() {
		...
		assertEquals("scheme://authority!/device:/foo/bar?query",
				uri.toString());
	}
	...
	public void testResolveB3() {
		...
		URI uri = URI.createHierarchicalURI(segments, query, fragment);
		assertEquals("scheme://authority!/device:/foo/foo/bar?query#fragment",
				uri.resolve(base, preserve).toString());
	}
	...
	public void testDeresolveA1() {
		URI uri = URI
				.createURI("scheme://authority!/device:/foo/foo/bar?query#fragment");
		URI base = URI.createURI("here");// non-hierarchical
	...
	// Test de deresolve(String base, boolean preserveRootParents, boolean
	// anyRelPath, boolean shorterRelPath)
	@Test
	public void testDeresolveB1() {
		...
		URI base = URI.createURI("here");// non-hierarchical
		assertEquals(uri.toString(),
				uri.deresolve(base, preserve, anyRel, shorterRel).toString());
	}
	...
	public void testDeresolveB3() {
		...
		URI base = URI.createHierarchicalURI(scheme, authority, device,
				segments, query, fragment);
		assertTrue(uri.deresolve(base, preserve, anyRel, shorterRel)
				.hasRelativePath());
	}
	...
	public void testTrimFileExtension2() {
		...
		URI new_uri = URI.createHierarchicalURI(new_scheme, new_authority,
				new_device, new_segments, new_query, new_fragment);
