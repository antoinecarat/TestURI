...
public abstract class URI {
	...
	public static URI createURIWithCache(String uri) {
		...
		return index == -1 ? URI_Const.POOL.intern(uri) : URI_Const.POOL
				.intern(uri.substring(0, index)).appendFragment(
